  ...
  return (
    (0, l.useEffect)(() => {
      ...
      let n = new IntersectionObserver(
        ([e]) => {
          e.isIntersecting && (t.classList.add(`active`), n.unobserve(t));
        },
        { threshold: 0.15 },
      );
...
function m({ id: e, className: t = ``, children: n }) {
  return (0, d.jsx)(`section`, {
    ref: f(),
    id: e,
    className: `rv2-reveal relative pt-32 mb-48 ${t}`,
    children: n,
  });
}
function h({
  ...
  title: n,
  description: r,
  iconClass: i = `rv2-icon-luminous`,
  rightLabel: a,
  className: o = ``,
}) {
  return (0, d.jsxs)(`div`, {
    className: `rv2-panel rv2-panel-hoverable ${o}`,
    style: {
      padding: `2rem`,
      display: `flex`,
      ...
      (0, d.jsxs)(`div`, {
        ...
        children: [
          (0, d.jsx)(`div`, {
            ...
            children: (0, d.jsx)(`span`, { className: i, children: e }),
          }),
          a ||
            (t &&
              (0, d.jsx)(`span`, {
                className: `rv2-micro-label`,
                style: { opacity: 0.3 },
                children: t,
              })),
        ],
...
function g() {
  let e = p(),
    t = f();
  return (0, d.jsxs)(`div`, {
    className: `roadmap-v2`,
    children: [
      (0, d.jsx)(`div`, {
        className: `rv2-ambient-glow`,
        style: {
      ...
      (0, d.jsx)(`div`, {
        className: `rv2-timeline-spine`,
        style: { display: `none` },
        children: (0, d.jsx)(`div`, {
          className: `rv2-timeline-progress`,
          style: { height: `${e}%` },
        }),
      }),
      (0, d.jsx)(`style`, {
        children: `@media(min-width:1024px){.rv2-timeline-spine{display:block!important}}`,
      }),
      (0, d.jsxs)(`main`, {
        style: {
          position: `relative`,
        ...
        children: [
          (0, d.jsx)(`section`, {
            ...
            children: (0, d.jsxs)(`div`, {
              style: {
                marginLeft: `max(0px, calc(50% - 320px + 48px))`,
                maxWidth: `48rem`,
                position: `relative`,
              },
              children: [
                  ...
                  children: [
                    (0, d.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, d.jsx)(`div`, { className: `rv2-pulse-ring` }),
                      ],
                    }),
                    (0, d.jsxs)(`div`, {
                      style: {
                  ...
                  children: [
                    ...
                    (0, d.jsx)(`span`, {
                      style: {
                        ...
                        backgroundImage: `linear-gradient(to right, var(--emerald-300), var(--emerald-500))`,
                      },
                      children: `вместе с авторами.`,
                    }),
                    (0, d.jsx)(`br`, {}),
                    `Вот что вас ждёт.`,
                  ],
                ...
                (0, d.jsx)(`p`, {
                  ...
                  children: `Прозрачный план развития платформы — от альфы до релиза. Конкретные даты, конкретные функции. Без «скоро» и «в планах».`,
                }),
                (0, d.jsx)(`div`, {
                  style: {
                    display: `flex`,
          ...
          (0, d.jsx)(m, {
            id: `now`,
            children: (0, d.jsxs)(`div`, {
              style: { marginLeft: `max(0px, calc(50% - 320px + 48px))` },
              children: [
                (0, d.jsxs)(`div`, {
                  style: {
                    display: `flex`,
                ...
                (0, d.jsx)(`p`, {
                  ...
                  children: `Uppora принимает реальные донаты от реальных людей. Прямо сейчас.`,
                }),
                (0, d.jsxs)(`div`, {
                  style: {
                    display: `grid`,
                  ...
                  className: `rv2-grid-now`,
                  children: [
                    (0, d.jsx)(`style`, {
                      children: `.rv2-grid-now{grid-template-columns:1fr}@media(min-width:768px){.rv2-grid-now{grid-template-columns:repeat(2,1fr)}}@media(min-width:768px){.rv2-grid-now>.rv2-card-wide{grid-column:span 2}}@media(min-width:1024px){.rv2-grid-now>.rv2-card-wide{grid-column:span 1}}`,
                    }),
                    (0, d.jsx)(h, {
                      icon: (0, d.jsx)(`svg`, {
                        width: `24`,
          ...
          (0, d.jsx)(m, {
            ...
            children: (0, d.jsxs)(`div`, {
              ...
              className: `rv2-april-layout`,
              children: [
                (0, d.jsx)(`style`, {
                  children: `.rv2-april-layout{flex-direction:column}@media(min-width:1024px){.rv2-april-layout{flex-direction:row}}`,
                }),
                (0, d.jsxs)(`div`, {
                  style: { flex: 1 },
                  children: [
                    (0, d.jsxs)(`div`, {
                      ...
                      children: [
                        (0, d.jsx)(`span`, {
                          className: `rv2-micro-label rv2-animate-pulse`,
                          style: {
                            padding: `4px 8px`,
                            background: `rgba(16,185,129,0.1)`,
                            border: `1px solid rgba(16,185,129,0.3)`,
                          ...
                          children: `⏳ ЧЕРЕЗ 3 НЕДЕЛИ`,
                        }),
                        (0, d.jsx)(`span`, {
                          className: `rv2-micro-label`,
                          style: { color: `var(--muted)` },
                          children: `15 Апреля 2026`,
                        }),
                      ],
                    }),
                    (0, d.jsxs)(`h2`, {
                      ...
                      children: [
                        `Uppora становится вашим`,
                        (0, d.jsx)(`br`, {}),
                        `ежедневным инструментом`,
                      ],
                    }),
                    (0, d.jsx)(`p`, {
                      style: {
                      ...
                      children: `Платформа перестаёт быть «просто страницей». Появляется обратная связь, уведомления и PWA приложение.`,
                    }),
                    (0, d.jsxs)(`div`, {
                      style: {
                        display: `flex`,
                      ...
                      children: [
                        (0, d.jsx)(`div`, { className: `rv2-step-line` }),
                        [
                          {
                            num: `01`,
                            title: `PWA — приложение на телефоне`,
                            desc: `Добавляете Uppora на главный экран — работает как нативное приложение. Push-уведомления, быстрый доступ.`,
                          },
                          {
                            num: `02`,
                            title: `Комментарии от донатеров`,
                            desc: `Впервые увидите не просто цифру, а человека. Слова благодарности, вопросы. Вы отвечаете прямо в кабинете.`,
                          },
                          {
                            num: `03`,
                            title: `Уведомления в реальном времени`,
                            desc: `Push на телефон и email о каждом новом донате. Не надо заходить и проверять — Uppora сама скажет.`,
                          },
                          {
                            num: `04`,
                            title: `Профиль автора & Подписчики`,
                            desc: `Полноценная визитка. Люди могут подписаться на ваш проект. Начало аудитории внутри платформы.`,
                          },
                        ].map((e) =>
                          (0, d.jsxs)(
                            `div`,
                ...
                (0, d.jsx)(`div`, {
                  ...
                  className: `lg:mt-12`,
                  children: (0, d.jsxs)(`div`, {
                    className: `rv2-mockup-container`,
                    style: {
                      height: 500,
                      padding: 16,
                      display: `flex`,
                    ...
                    children: [
                      (0, d.jsx)(`div`, { className: `rv2-mockup-shine` }),
                      (0, d.jsxs)(`div`, {
                        style: {
                          display: `flex`,
                          justifyContent: `space-between`,
                      ...
                      (0, d.jsxs)(`div`, {
                        className: `rv2-panel rv2-mockup-notification`,
                        style: {
                          padding: 16,
                          margin: `16px 8px 0`,
                          ...
                          (0, d.jsxs)(`div`, {
                            ...
                            children: [
                              ...
                              (0, d.jsx)(`span`, {
                                ...
                                children: `500₽ от Михаила`,
                              }),
                            ],
                          }),
                          (0, d.jsx)(`div`, {
                            style: { fontSize: 12, color: `var(--muted)` },
                            children: `«Спасибо за вчерашнюю лекцию! Жду следующую.»`,
                          }),
                        ],
                      }),
                      (0, d.jsx)(`div`, {
            ...
            children: (0, d.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, d.jsx)(`p`, {
                  ...
                  children: `Открытая регистрация для всех. Те, кто пришёл раньше — уже освоились, набрали подписчиков и получили статус Founding Creator.`,
                }),
                (0, d.jsxs)(`div`, {
                  style: {
                    display: `grid`,
                  ...
                  className: `rv2-grid-may`,
                  children: [
                    (0, d.jsx)(`style`, {
                      children: `.rv2-grid-may{grid-template-columns:1fr}@media(min-width:768px){.rv2-grid-may{grid-template-columns:repeat(3,1fr)}}`,
                    }),
                    (0, d.jsx)(`div`, {
                      style: {
                        position: `absolute`,
                      ...
                      children: (0, d.jsxs)(`svg`, {
                        ...
                        style: {
                          width: `100%`,
                          height: `100%`,
                          animation: `rv2-spin-slow 60s linear infinite`,
                        },
                        children: [
                          (0, d.jsx)(`circle`, {
                            cx: `50`,
                    ...
                    (0, d.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, d.jsx)(`p`, {
                          ...
                          children: `Любой автор может зарегистрироваться. Приглашение больше не нужно. Масштабирование платформы.`,
                        }),
                      ],
                    }),
                    (0, d.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, d.jsx)(`h3`, {
                          ...
                          children: `Модерация и безопасность`,
                        }),
                        (0, d.jsx)(`p`, {
                          style: {
                            color: `var(--muted)`,
                          ...
                          children: `Фильтр токсичных комментариев. Вход через VK/Yandex в один клик. 2FA для защиты аккаунта.`,
                        }),
                      ],
                    }),
                    (0, d.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, d.jsx)(`h3`, {
                          ...
                          children: `Расширенная статистика`,
                        }),
                        (0, d.jsx)(`p`, {
                          style: {
                            color: `var(--muted)`,
                          ...
                          children: `Фильтры по дате, сумме, источнику. Экспорт данных. Полная картина: кто, сколько, когда, откуда.`,
                        }),
                      ],
                    }),
                  ],
            ...
            children: (0, d.jsxs)(`div`, {
              ...
              children: [
                (0, d.jsxs)(`div`, {
                  ...
                  children: [
                    (0, d.jsx)(`span`, {
                      ...
                      children: `☀️ ЛЕТО 2026`,
                    }),
                    (0, d.jsx)(`span`, {
                      className: `rv2-micro-label`,
                      style: { color: `var(--muted)` },
                      children: `Инструменты роста`,
                    }),
                  ],
                }),
                (0, d.jsxs)(`h2`, {
                ...
                (0, d.jsx)(`p`, {
                  ...
                  children: `До этого момента платформа принимала деньги. Теперь — помогает зарабатывать больше.`,
                }),
                (0, d.jsxs)(`div`, {
                  style: { display: `grid`, gap: `2rem 3rem` },
                  className: `rv2-grid-summer`,
                  children: [
                    (0, d.jsx)(`style`, {
                      children: `.rv2-grid-summer{grid-template-columns:1fr}@media(min-width:768px){.rv2-grid-summer{grid-template-columns:repeat(2,1fr);gap:2rem 3rem}}`,
                    }),
                    [
                      {
                        title: `Детальные отчёты`,
                        desc: `Откуда приходят донатеры, средний чек, динамика. Данные → понимание → решения → рост.`,
                        icon: (0, d.jsx)(`path`, {
                          strokeLinecap: `round`,
                          strokeLinejoin: `round`,
                          strokeWidth: `2`,
                      ...
                      },
                      {
                        ...
                        desc: `Спросите аудиторию: какую тему раскрыть следующей? Голосование прямо на странице.`,
                        icon: (0, d.jsx)(`path`, {
                          strokeLinecap: `round`,
                          strokeLinejoin: `round`,
                          strokeWidth: `2`,
                      ...
                      {
                        title: `Блог на странице проекта`,
                        desc: `Публикуйте обновления, закулисье. Не нужен отдельный сайт или канал — всё в одном месте.`,
                        icon: (0, d.jsx)(`path`, {
                          strokeLinecap: `round`,
                          strokeLinejoin: `round`,
                          strokeWidth: `2`,
                      ...
                      {
                        title: `Виджеты для встраивания`,
                        desc: `Кнопка "Поддержать" для вашего сайта или блога. Одна строка кода — донатеры приходят отовсюду.`,
                        icon: (0, d.jsx)(`path`, {
                          strokeLinecap: `round`,
                          strokeLinejoin: `round`,
                          strokeWidth: `2`,
                      ...
                      },
                      {
                        ...
                        desc: `Подтверждённый проект = галочка доверия. Донатеры видят проверку, конверсия растёт.`,
                        icon: (0, d.jsx)(`path`, {
                          strokeLinecap: `round`,
                          strokeLinejoin: `round`,
                          strokeWidth: `2`,
                      ...
                      },
                      {
                        ...
                        desc: `Портфолио работ, интеграция с соцсетями. Полноценная визитка для любой аудитории.`,
                        icon: (0, d.jsx)(`path`, {
                          strokeLinecap: `round`,
                          strokeLinejoin: `round`,
                          strokeWidth: `2`,
                      ...
                      (0, d.jsxs)(
                        `div`,
                        {
                          className: `rv2-summer-feature ${e.emeraldHover ? `` : `rv2-amber-hover`}`,
                          children: [
                            (0, d.jsx)(`div`, {
                              className: `rv2-feature-icon`,
                              children: (0, d.jsx)(`svg`, {
                                fill: `none`,
                                stroke: `currentColor`,
                                viewBox: `0 0 24 24`,
            ...
            children: (0, d.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, d.jsx)(`p`, {
                  ...
                  children: `Uppora — не эксперимент. Это платформа, которая работает для авторов.`,
                }),
                (0, d.jsxs)(`div`, {
                  style: { display: `grid`, gap: `1rem`, marginBottom: `4rem` },
                  className: `rv2-grid-sept`,
                  children: [
                    (0, d.jsx)(`style`, {
                      children: `.rv2-grid-sept{grid-template-columns:1fr}@media(min-width:768px){.rv2-grid-sept{grid-template-columns:repeat(3,1fr)}}`,
                    }),
                    (0, d.jsxs)(`div`, {
                      className: `rv2-panel`,
                      style: {
                      ...
                      children: [
                        (0, d.jsx)(`h4`, {
                          ...
                          children: `Каталог авторов`,
                        }),
                        (0, d.jsx)(`p`, {
                          style: { fontSize: `0.75rem`, color: `var(--muted)` },
                          children: `Входящий трафик от платформы. Новые донатеры находят вас без вашего участия.`,
                        }),
                      ],
                    }),
                    (0, d.jsxs)(`div`, {
                      ...
                      children: [
                        (0, d.jsx)(`h4`, {
                          ...
                          children: `Лента активности`,
                        }),
                        (0, d.jsx)(`p`, {
                          style: { fontSize: `0.75rem`, color: `var(--muted)` },
                          children: `Ваши обновления видят все подписчики. Без алгоритмов, без оплаты за охват.`,
                        }),
                      ],
                    }),
                    (0, d.jsxs)(`div`, {
                      ...
                      children: [
                        (0, d.jsx)(`h4`, {
                          ...
                          children: `Стабильность 99.5%`,
                        }),
                        (0, d.jsx)(`p`, {
                          style: { fontSize: `0.75rem`, color: `var(--muted)` },
                          children: `Мониторинг 24/7, автоматические бэкапы, CDN. Техника работает незаметно.`,
                        }),
                      ],
                    }),
                  ],
                        ...
                        (0, d.jsx)(`thead`, {
                          children: (0, d.jsxs)(`tr`, {
                            ...
                            children: [
                              ...
                              (0, d.jsx)(`th`, { children: `Boosty` }),
                              (0, d.jsx)(`th`, { children: `Донатион` }),
                              (0, d.jsx)(`th`, { children: `VK Donut` }),
                            ],
                          }),
                        }),
                        (0, d.jsxs)(`tbody`, {
              ...
              children: (0, d.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, d.jsxs)(`div`, {
                    ...
                    className: `rv2-cta-inner`,
                    children: [
                      (0, d.jsx)(`style`, {
                        children: `@media(min-width:768px){.rv2-cta-inner{padding:3rem}}`,
                      }),
                      (0, d.jsxs)(`div`, {
                        style: {
                          maxWidth: `40rem`,
                        ...
                        children: [
                          ...
                          (0, d.jsx)(`p`, {
                            ...
                            children: `Это не маркетинговый трюк. 50 мест — реальное ограничение альфы. Когда закончатся — закончатся.`,
                          }),
                        ],
                      }),
                      (0, d.jsxs)(`div`, {
                        ...
                        className: `rv2-grid-perks`,
                        children: [
                          (0, d.jsx)(`style`, {
                            children: `.rv2-grid-perks{grid-template-columns:1fr}@media(min-width:640px){.rv2-grid-perks{grid-template-columns:repeat(2,1fr)}}`,
                          }),
                          [
                            {
                              icon: (0, d.jsx)(`span`, {
                            ...
                            },
                            {
                              ...
                              title: `Значок навсегда`,
                              desc: `Founding Creator — как первые пользователи Instagram. Статус, который не покупается.`,
                            },
                            {
                              icon: (0, d.jsx)(`svg`, {
                                width: `24`,
                              ...
                              title: `Прямой доступ к команде`,
                              desc: `Личный чат с основателями. Ваши пожелания = наш приоритет.`,
                            },
                            {
                              icon: (0, d.jsx)(`svg`, {
                                width: `24`,
                              ...
                              title: `Консьерж-онбординг`,
                              desc: `Мы сами настроим страницу. Ваших усилий: 5 минут.`,
                            },
                          ].map((e) =>
                            (0, d.jsxs)(
                              `div`,
                        ...
                        children: (0, d.jsxs)(`form`, {
                          ...
                          children: [
                            ...
                            (0, d.jsx)(`input`, {
                              type: `url`,
                              className: `rv2-input-tech`,
                              placeholder: `Ссылка на канал / проект`,
                              required: !0,
                              style: {
                                padding: `0.875rem 1rem`,
                                borderRadius: 8,
                            ...
                            (0, d.jsx)(`button`, {
                              ...
                              children: `Стать Founding Creator`,
                            }),
                            (0, d.jsx)(`p`, {
                              className: `rv2-micro-label`,
                              style: {
                              ...
                              children: `Мы свяжемся в течение 24 часов и всё настроим за вас.`,
                            }),
                          ],
                        }),
                      }),
...
(0, c.createRoot)(document.getElementById(`root`)).render(
  (0, d.jsx)(l.StrictMode, { children: (0, d.jsx)(g, {}) }),
);
